...
public class SmartHome {
 ...
 SmartHome(String name, int serialNumber, String addressName, String addressNumber, String city, String country, String postalCode, int light1PortNum, int light2PortNum, int door1PortNum, int door2PortNum, int microwavePortNum, int tvPortNum, int waterHeaterPortNum) {
     this.name = name;
 ...
 public String toString() {
     return "SmartHome(name=" + this.getName() + ", serialNumber=" + this.getSerialNumber() + ", addressName=" + this.getAddressName() + ", addressNumber=" + this.getAddressNumber() + ", city=" + this.getCity() + ", country=" + this.getCountry() + ", postalCode=" + this.getPostalCode() + ", light1PortNum=" + this.getLight1PortNum() + ", light2PortNum=" + this.getLight2PortNum() + ", door1PortNum=" + this.getDoor1PortNum() + ", door2PortNum=" + this.getDoor2PortNum() + ", microwavePortNum=" + this.getMicrowavePortNum() + ", tvPortNum=" + this.getTvPortNum() + ", waterHeaterPortNum=" + this.getWaterHeaterPortNum() + ")";
 }
 ...
 public static class SmartHomeBuilder {
     ...
     public SmartHome build() {
         return new SmartHome(this.name, this.serialNumber, this.addressName, this.addressNumber, this.city, this.country, this.postalCode, this.light1PortNum, this.light2PortNum, this.door1PortNum, this.door2PortNum, this.microwavePortNum, this.tvPortNum, this.waterHeaterPortNum);
     }

     public String toString() {
         return "SmartHome.SmartHomeBuilder(name=" + this.name + ", serialNumber=" + this.serialNumber + ", addressName=" + this.addressName + ", addressNumber=" + this.addressNumber + ", city=" + this.city + ", country=" + this.country + ", postalCode=" + this.postalCode + ", light1PortNum=" + this.light1PortNum + ", light2PortNum=" + this.light2PortNum + ", door1PortNum=" + this.door1PortNum + ", door2PortNum=" + this.door2PortNum + ", microwavePortNum=" + this.microwavePortNum + ", tvPortNum=" + this.tvPortNum + ", waterHeaterPortNum=" + this.waterHeaterPortNum + ")";
     }
 }
}
