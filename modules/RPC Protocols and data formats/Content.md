...
- [Олег Докука — Протокол RSocket — будущее реактивных приложений](https://www.youtube.com/watch?v=tSVjUKZ8Eg8) 1 hr 00 min
...
- [Сказ о том, как разбирался в gRPC и Websocket](https://dev.by/blogs/godel-technologies-europe/articles/skaz-o-tom-kak-razbiralsya-v-grpc-i-websocket)
- [Working with Apache Thrift](https://www.baeldung.com/apache-thrift)
- [Thrift vs ProtoBuf](https://www.youtube.com/watch?v=9D6hkKw_oJE)
- [Apache Thrift с Java быстрый старт](https://coderlessons.com/articles/java/apache-thrift-s-java-bystryi-start)
- [Guide to Apache Avro](https://www.baeldung.com/java-apache-avro)
- [Avro serialization в Kafka](https://habr.com/ru/post/492312/)
