**Topics:**
=======================
- Microservice design tactic: pros and cons
- Communication between microservices
- Monitoring and logging
- Service discovery using Eureka, Zuul, Hystrix, Feign(and Ribbon under-the-hood)
- Containers with SpringBoot, Docker, Swarm
- k8s basics
- Netflix OOS stack
...
- [Gateway with Zuul](https://www.youtube.com/watch?v=mHHHpxJuTAo) 1h
