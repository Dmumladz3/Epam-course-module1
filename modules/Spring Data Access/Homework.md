...
Add Hibernate caching to all getById() methods. Add query caching. Show that you caches are really working in tests (cache hits count, cache miss count) Hint: org.hibernate.stat.Statistic. (2 points)  