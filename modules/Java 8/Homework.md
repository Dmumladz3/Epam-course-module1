...
3. Java8ParallelAggregator – should use parallel streams from Java 8 Stream API
...
If you run tests, you will see a lot of red. “What tests…?” , you may wonder. Yes, I wrote them for you, so now you are driven by tests (see 'How to run tests' section below for more details). Aggregator interface has small javadocs to help you in understanding how each of the method behaves.
...
Please, use zip archive as the base code for your HW